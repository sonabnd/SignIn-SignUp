      ...
      <div className={classes.signModal}>
        <div className={classes.welcomeContainer}>
          ...
          <div className={classes.rightText}>
            ...
            <Link to={Routes.signin} className={classes.SignInLink}>
              {en.signin}
            </Link>
          </div>
        </div>
        ...
        >
          ...
          <div className={classes.inlineFields}>
            <Form.Item
              ...
              name='username'
              rules={[
                { required: true, message: en.signInEmptPassword },
              ]}
          ...
          <Form.Item
            ...
            name='password'
            rules={[{ required: true, message: en.signInEmptPassword }]}
            className={classes.formItem}
          >
            <Input.Password
          ...
          <Form.Item>
            <ButtonComponent className={classes.signUpButton} htmlType='submit'>
              {en.signup}
            </ButtonComponent>
          </Form.Item>
        </Form>
